...
node *findNode (list l, node *n, int *position)
{
    ...
    {
        if (compareState(elementAt(l, i)->state, n->state))
        {
            *position = i;
...
{
    State starState;
    starState.puzzle[0][0] = 2;
    starState.puzzle[0][1] = 8;
    starState.puzzle[0][2] = 1;
    starState.puzzle[1][0] = EMPTY;
    starState.puzzle[1][1] = 4;
    starState.puzzle[1][2] = 3;
    starState.puzzle[2][0] = 7;
    starState.puzzle[2][1] = 6;
    starState.puzzle[2][2] = 5;
    starState.emptyRow = 1;
    starState.emptyCol = 0;
